...
|287  | [Find the Duplicate Number](https://leetcode.com/problems/find-the-duplicate-number)|[C++](https://github.com/ljin029/leetcode/blob/master/Stack/findTheDuplicateNumber.cpp)|Hard | |Binary Search, Two Pointers |O(n) | O(1) |
...
|222| [Count Complete Tree Nodes](https://leetcode.com/problems/count-complete-tree-nodes)|[C++](https://github.com/ljin029/leetcode/blob/master/Binary%20Search/countCompleteTreeNodes.cpp)|Medium | |Binary Search |O((logn)^2) | O(1) |
...
|3  | [Longest Substring Without Repeating Characters](https://leetcode.com/problems/longest-substring-without-repeating-characters)|[C++](longestSubstringWithoutRepeatingCharacters.cpp) |Medium | |
...
|113  | [Path Sum](https://oj.leetcode.com/problems/path-sum-ii/)|[C++](https://github.com/ljin029/leetcode/blob/master/Depth%20First%20Search/pathSumII.cpp) |Medium | | |O(n)| O(h) |


### Backtracking
| #        | Title           |Solution  | Diffculty  | Tag  | Note  | Time |Space |
| ------------- |:-------------:| -----:| -----:| -----:| -----:| -----:| -----:|
|17  | [Letter Combinations of a Phone Number](https://oj.leetcode.com/problems/letter-combinations-of-a-phone-number/)|[C++](https://github.com/ljin029/leetcode/blob/master/Backtracking/letterCombinationsOfAPhoneNumber.cpp) |Medium | | |O(n * 4^n) | O(n) |
|131  | [Palindrome Partitioning](https://oj.leetcode.com/problems/palindrome-partitioning/)|[C++](https://github.com/ljin029/leetcode/blob/master/Backtracking/palindromePartitioning.cpp) |Medium | | |O(n^2) ~ O(2^n) | O(n^2) |
